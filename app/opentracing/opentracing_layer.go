...
func (a *OpenTracingAppLayer) GetFileInfosByChannelId(channelId string, page, perPage int) ([]*model.FileInfo, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetFileInfosByChannelId")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetFileInfosByChannelId(channelId, page, perPage)
